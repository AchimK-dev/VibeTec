            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-base-content/70 mb-8">
                  This is a demo project showcasing a full-stack DJ booking
                  platform. It demonstrates modern web development practices
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-base-300 p-6 rounded-lg">
                  ...
                  <a
                    href="https://www.linkedin.com/in/achim-klein-dev"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary hover:underline inline-flex items-center gap-2"
                  >
              ...
              <div className="bg-base-300 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-base-content/70">
                  <div>• React.js</div>
                  <div>• Node.js</div>
                  <div>• MongoDB</div>
                  <div>• Express.js</div>
              ...
              <div className="text-center pt-4">
                <p className="text-base-content/60">
                  This is a demonstration project and not a real business.
                </p>
              </div>
            </div>
          </div>
