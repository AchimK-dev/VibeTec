    ...
    <div className="page-container-no-padding">
      ...
      <div className="w-full grid grid-cols-3 gap-4 min-h-screen">
        ...
        <div className="col-span-1 bg-[#BDFF00] rounded-xl shadow-lg p-8 flex flex-col justify-center items-center">
          ...
          <Link to="/login" className="btn font-bold text-black text-xl bg-white rounded-3xl w-40" style={{border: 'none'}}>
            Sign In
          </Link>
        </div>
      ...
      <label className='input flex items-center gap-2 w-full bg-[#0C0F1A] border-1 border-[#BDFF00]'>
        ...
        <label className='input flex items-center gap-2 w-full bg-[#0C0F1A] border-1 border-[#BDFF00]'>
          ...
          />
              ...
              <button className='btn self-center bg-[#BDFF00] rounded-3xl w-40 text-black font-bold mt-5' disabled={loading}>
                Create Account
              </button>
